...
access_token = "make your own and DO NOT COMMIT IT istg"
...
if __name__ == '__main__':
    ### uncomment this section once at the beginning of the course to flush out the old repos ###
    # delete_allowed = True
    # repos = get_course_repos('3002', 'B23')
    # print(repos)
    # for repo in repos:
    #     delete_repo(repo)
